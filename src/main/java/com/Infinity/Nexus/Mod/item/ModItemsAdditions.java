...
public class ModItemsAdditions {
    ...
    public static final RegistryObject<Item> REINFORCED_COMPONENT = ITEMS.register("reinforced_component", () -> new ComponentItem(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
