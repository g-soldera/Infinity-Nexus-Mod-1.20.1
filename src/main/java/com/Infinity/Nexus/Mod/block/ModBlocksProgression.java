...
public class ModBlocksProgression {
    ...
    public static final RegistryObject<Block> WOOD_MACHINE_CASING = registerBlock("wood_machine_casing",() -> new Block(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 1.0f).sound(SoundType.WOOD).mapColor(MapColor.WOOD)));
    public static final RegistryObject<Block> COPPER_MACHINE_CASING = registerBlock("copper_machine_casing",() -> new Block(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 3.0f).sound(SoundType.COPPER).mapColor(MapColor.COLOR_ORANGE)));
    public static final RegistryObject<Block> GOLD_MACHINE_CASING = registerBlock("gold_machine_casing",() -> new Block(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.METAL).mapColor(MapColor.GOLD)));
    ...
    public static final RegistryObject<Block> IRON_MACHINE_CASING = registerBlock("iron_machine_casing",() -> new Block(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(3.0f, 6.0f).sound(SoundType.METAL).mapColor(MapColor.RAW_IRON)));
