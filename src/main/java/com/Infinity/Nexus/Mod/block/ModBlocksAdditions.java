...
public class ModBlocksAdditions {
    ...
    public static final RegistryObject<Block> DISPLAY = registerBlock("display", () -> new Display(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).requiresCorrectToolForDrops().strength(3.0f, 6.0f).noOcclusion()));
