...
public class MinerMenu extends AbstractContainerMenu {
    ...
    public MinerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new InputSlot(iItemHandler, 14, 116, 11));
            this.addSlot(new LinkSlot(iItemHandler, 15, 116, 29));
            this.addSlot(new InputSlot(iItemHandler, 16, 116, 47));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocksAdditions.MINER.get());
    }
