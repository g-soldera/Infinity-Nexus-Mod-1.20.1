...
public class SqueezerMenu extends AbstractContainerMenu {
    ...
    public SqueezerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SQUEEZER_MENU.get(), pContainerId);
        checkContainerSize(inv, TE_INVENTORY_SLOT_COUNT);
        blockEntity = ((SqueezerBlockEntity) entity);
