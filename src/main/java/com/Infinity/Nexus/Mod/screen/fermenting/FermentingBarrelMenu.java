...
public class FermentingBarrelMenu extends AbstractContainerMenu {
    ...
    public FermentingBarrelMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public FermentingBarrelMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FERMENTING_BARREL_MENU.get(), pContainerId);
    ...
    public FermentingBarrelBlockEntity getBlockEntity(){
        return blockEntity;
    }
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocksAdditions.FERMENTING_BARREL.get());
    }
