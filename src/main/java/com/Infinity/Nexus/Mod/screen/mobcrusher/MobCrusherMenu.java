...
public class MobCrusherMenu extends AbstractContainerMenu {
    ...
    public MobCrusherMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MOB_CRUSHER_MENU.get(), pContainerId);
        checkContainerSize(inv, TE_INVENTORY_SLOT_COUNT);
        blockEntity = ((MobCrusherBlockEntity) entity);
