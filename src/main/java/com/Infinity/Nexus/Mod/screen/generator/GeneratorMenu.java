...
public class GeneratorMenu extends AbstractContainerMenu {
    ...
    public GeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new InputSlot(iItemHandler, 0, 80, 47));


            this.addSlot(new UpgradeSlot(iItemHandler, 1, 12, 6));
            this.addSlot(new UpgradeSlot(iItemHandler, 2, 35, 6));
            this.addSlot(new UpgradeSlot(iItemHandler, 3, 12, 29));
            this.addSlot(new UpgradeSlot(iItemHandler, 4, 35, 29));

            this.addSlot(new ComponentSlot(iItemHandler, 5, 24, 52));
        });
